...
const Button = (props) => {
  ...
  if (children) {
    button = (
      <NBButton style={[styles.buttonStyle, buttonStyle]} transparent={transparent} {...otherProps}>
        {children }
      </NBButton>
    );
  } else {
    button = (
      <NBButton transparent={transparent} {...otherProps}>
        { leftChildren }
        <TranslateText
          style={textStyle}
          label={textLabel}
...
Button.propTypes = {
  ...
  transparent: PropTypes.bool, // 按钮是否透明
